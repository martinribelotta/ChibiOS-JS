...
static BaseSequentialStream *fd_list[] = {
		(BaseSequentialStream *)&SDU1, /* 0 stdin */
		(BaseSequentialStream *)&SDU1, /* 1 stdout */
		(BaseSequentialStream *)&SDU1, /* 2 stderr */
};
...
int main(void) {
  ...
  posix_set_static_fd(fd_list, sizeof(fd_list));

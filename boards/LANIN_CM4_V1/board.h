 ...
 * PA9  - USART1_TX                 (alternate 8).
 * PA10 - USART1_RX                 (alternate 8).
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_DETECT_USD, 0) 					|	\
				     												 PIN_AFIO_AF(GPIOA_USART1_TX, 8) 						|	\
                                     PIN_AFIO_AF(GPIOA_USART1_RX, 8) 						|	\
 ...
 * PB7  - I2C1_SCA                  (alternate 4).
 * PB8  - PIN8	                    (input pullup).
 * PB9  - CTRL_RS485_1              (output pushpull maximum).
 * PB10 - USART3_TX                 (alternate 8).
 * PB11 - USART3_RX                 (alternate 8).
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_PIN8, 0)							|	\
                                     ...
                                     PIN_AFIO_AF(GPIOB_USART3_TX, 8)				|	\
                                     PIN_AFIO_AF(GPIOB_USART3_RX, 8)				|	\
 ...
 * GPIOG setup:
 *
 * PG0  - FLT_USB                   (output pushpull maximum).
 ...
 */
#define VAL_GPIOG_MODER             (PIN_MODE_OUTPUT(GPIOG_FLT_USB) |           \
...
#define VAL_GPIOG_PUPDR             (PIN_PUPDR_PULLUP(GPIOG_FLT_USB) |         \
